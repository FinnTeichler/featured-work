...
{
    public class CBS_InteractDropItem : CBStateBase
    {
        ...
        public CBS_InteractDropItem(CreatureReference creatureReference, float duration) : base(creatureReference)
        {
        ...
        public override void OnEnter()
        {
            ...
            target = interactionData.DroppedItem.transform;
            ...
            if (creatureReference.InfoHub.AgentReachedDestination())
            {
                ...
                if (durationTimer >= duration)
                {
                    ...
                    else
                    {
                        ...
                        GameObject.Destroy(interactionData.DroppedItem.gameObject);
                        durationTimer = 0f;
        ...
        {
            creatureReference.Agent.destination = creatureReference.MainTransform.position;
        }
