...
namespace SpiritGarden.Character
{
    public class CharacterAudioControl : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (!characterReference.AnimatorComponent)
        ...
        void FootStepUpdate(float _movementSpeed)
        {
            ...
            if (useAnimationBasedFootsteps)
            {
                ...
                float _newFootStepValue = characterReference.AnimatorComponent.GetFloat("FootStep");
                ...
                if ((currentFootStepValue <= 0f && _newFootStepValue > 0f) || (currentFootStepValue >= 0f && _newFootStepValue < 0f))
                {
                    ...
                    if (characterReference.CMFMover.IsGrounded() && _movementSpeed > _speedThreshold)
